...
const CoolFile = 'J:/2021 Finance/OT/Temp Analysis/2021 Temp Working hours for Budget - Fullerton.xlsx'
...
var excelInJSON = xlsx.utils.sheet_to_json(wb.Sheets["Fullerton 111"], {defval: '', range: {s:{c:1, r:1}, e:{c:7, r:58}}});
